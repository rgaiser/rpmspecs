# Generated from json_pure-1.4.6.gem by gem2rpm -*- rpm-spec -*-
...
mv %{buildroot}/%{_bindir}/edit_json.rb %{buildroot}/%{_bindir}/edit_json_pure.rb
mv %{buildroot}/%{_bindir}/prettify_json.rb %{buildroot}/%{_bindir}/prettify_json_pure.rb
...
%files
%defattr(-, root, root, -)
%{_bindir}/edit_json_pure.rb
%{_bindir}/prettify_json_pure.rb
