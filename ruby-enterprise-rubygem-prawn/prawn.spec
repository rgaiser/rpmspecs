...
Requires: ruby-enterprise-rubygem(prawn-core) >= 0.8.4
Requires: ruby-enterprise-rubygem(prawn-core) < 0.9
Requires: ruby-enterprise-rubygem(prawn-layout) >= 0.8.4
Requires: ruby-enterprise-rubygem(prawn-layout) < 0.9
Requires: ruby-enterprise-rubygem(prawn-security) >= 0.8.4
Requires: ruby-enterprise-rubygem(prawn-security) < 0.9
