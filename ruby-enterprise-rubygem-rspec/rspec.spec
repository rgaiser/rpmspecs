# Generated from rspec-2.1.0.gem by gem2rpm -*- rpm-spec -*-
...
Requires: ruby-enterprise-rubygem(rspec-core) >= 2.1.0
Requires: ruby-enterprise-rubygem(rspec-expectations) >= 2.1.0
Requires: ruby-enterprise-rubygem(rspec-mocks) >= 2.1.0
