...
Source1: http://puppetlabs.com/downloads/facter/facter-%{version}.tar.gz.sign

BuildRoot: %{_tmppath}/facter-%{version}-%{release}-root-%(%{__id_u} -n)
BuildArch: noarch
...
mv %{buildroot}/%{ruby_bindir}/facter %{buildroot}/%{_bindir}
